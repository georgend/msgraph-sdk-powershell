...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdismissusercalendargroupcalendareventinstancereminder
schema: 2.0.0
---
...
### Dismiss (Default)
```
Invoke-MgDismissUserCalendarGroupCalendarEventInstanceReminder -CalendarGroupId <String> -CalendarId <String>
 -EventId <String> -EventId1 <String> -UserId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissUserCalendarGroupCalendarEventInstanceReminder -InputObject <IUsersActionsIdentity>
