...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgacceptusereventcalendareventtentatively
schema: 2.0.0
---
...
```
Invoke-MgAcceptUserEventCalendarEventTentatively -EventId <String> -EventId1 <String> -UserId <String>
...
```
Invoke-MgAcceptUserEventCalendarEventTentatively -EventId <String> -EventId1 <String> -UserId <String>
 -BodyParameter <IPaths1FlenwhUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AcceptViaIdentity
```
Invoke-MgAcceptUserEventCalendarEventTentatively -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1FlenwhUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgAcceptUserEventCalendarEventTentatively -InputObject <IUsersActionsIdentity> [-Comment <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1FlenwhUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths1FlenwhUsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema
