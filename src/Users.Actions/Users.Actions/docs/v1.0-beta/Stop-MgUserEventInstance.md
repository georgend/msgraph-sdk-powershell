...
```
Stop-MgUserEventInstance -EventId <String> -EventId1 <String> -UserId <String> [-Comment <String>] [-PassThru]
...
```
Stop-MgUserEventInstance -InputObject <IUsersActionsIdentity> [-Comment <String>] [-PassThru] [-Confirm]
