...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgacceptusercalendargroupcalendareventtentatively
schema: 2.0.0
---
...
```
Invoke-MgAcceptUserCalendarGroupCalendarEventTentatively -CalendarGroupId <String> -CalendarId <String>
...
Invoke-MgAcceptUserCalendarGroupCalendarEventTentatively -CalendarGroupId <String> -CalendarId <String>
 ...
 -BodyParameter <IPathsDg14OjUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AcceptViaIdentity1
```
Invoke-MgAcceptUserCalendarGroupCalendarEventTentatively -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsDg14OjUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsDg14OjUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPathsDg14OjUsersUserIdCalendargroupsCalendargroupIdCalendarsCalendarIdEventsEventIdMicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema
