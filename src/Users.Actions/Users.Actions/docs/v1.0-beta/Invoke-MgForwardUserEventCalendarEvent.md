...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgforwardusereventcalendarevent
schema: 2.0.0
---
...
```
Invoke-MgForwardUserEventCalendarEvent -EventId <String> -EventId1 <String> -UserId <String>
...
```
Invoke-MgForwardUserEventCalendarEvent -EventId <String> -EventId1 <String> -UserId <String>
 -BodyParameter <IPaths5So465UsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ForwardViaIdentity
```
Invoke-MgForwardUserEventCalendarEvent -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths5So465UsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Invoke-MgForwardUserEventCalendarEvent -InputObject <IUsersActionsIdentity> [-Comment <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths5So465UsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths5So465UsersUserIdEventsEventIdCalendarEventsEventId1MicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
