...
```
Invoke-MgForwardUserEventInstance -EventId <String> -EventId1 <String> -UserId <String> [-Comment <String>]
...
```
Invoke-MgForwardUserEventInstance -InputObject <IUsersActionsIdentity> [-Comment <String>]
 [-ToRecipients <IMicrosoftGraphRecipient[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
