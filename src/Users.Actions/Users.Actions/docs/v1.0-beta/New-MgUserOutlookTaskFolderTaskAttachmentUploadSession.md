...
New-MgUserOutlookTaskFolderTaskAttachmentUploadSession -OutlookTaskFolderId <String> -OutlookTaskId <String>
 -UserId <String> [-AttachmentItemAttachmentType <String>] [-AttachmentItemContentType <String>]
 [-AttachmentItemIsInline] [-AttachmentItemName <String>] [-AttachmentItemSize <Int64>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
