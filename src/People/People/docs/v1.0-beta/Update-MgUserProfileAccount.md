...
```
Update-MgUserProfileAccount -UserAccountInformationId <String> -UserId <String> [-AgeGroup <String>]
 [-AllowedAudiences <String>] [-CountryCode <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-PreferredLanguageTagDisplayName <String>]
 [-PreferredLanguageTagLocale <String>] [-SourceType <String>] [-UserPrincipalName <String>] [-PassThru]
...
```
Update-MgUserProfileAccount -InputObject <IPeopleIdentity> [-AgeGroup <String>] [-AllowedAudiences <String>]
...
key: userAccountInformation-id of userAccountInformation
