...
```
Update-MgUserProfileAnniversary -PersonAnniversaryId <String> -UserId <String> [-AllowedAudiences <String>]
...
```
Update-MgUserProfileAnniversary -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-Date <DateTime>] [-Id <String>]
 [-InferenceConfidenceScore <Double>] [-InferenceUserHasVerifiedAccuracy]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-SourceType <String>]
 [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
...
### -PersonAnniversaryId
key: personAnniversary-id of personAnniversary
