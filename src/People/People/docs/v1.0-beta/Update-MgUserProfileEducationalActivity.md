...
Update-MgUserProfileEducationalActivity -EducationalActivityId <String> -UserId <String>
 ...
 [-CreatedDateTime <DateTime>] [-EndMonthYear <DateTime>] [-Id <String>] [-InferenceConfidenceScore <Double>]
...
```
Update-MgUserProfileEducationalActivity -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
...
key: educationalActivity-id of educationalActivity
