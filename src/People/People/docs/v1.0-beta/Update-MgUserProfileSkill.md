...
```
Update-MgUserProfileSkill -SkillProficiencyId <String> -UserId <String> [-AllowedAudiences <String>]
 [-Categories <String[]>] [-CollaborationTags <String[]>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Proficiency <String>] [-SourceType <String>] [-WebUrl <String>]
...
```
Update-MgUserProfileSkill -InputObject <IPeopleIdentity> [-AllowedAudiences <String>] [-Categories <String[]>]
 [-CollaborationTags <String[]>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Proficiency <String>] [-SourceType <String>] [-WebUrl <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -SkillProficiencyId
key: skillProficiency-id of skillProficiency
