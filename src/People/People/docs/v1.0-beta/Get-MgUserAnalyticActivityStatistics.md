...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguseranalyticactivitystatistics
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserAnalyticActivityStatistics -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>]
