...
```
New-MgUserProfileSkill -UserId <String> [-AllowedAudiences <String>] [-Categories <String[]>]
...
```
New-MgUserProfileSkill -InputObject <IPeopleIdentity> [-AllowedAudiences <String>] [-Categories <String[]>]
 [-CollaborationTags <String[]>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Proficiency <String>] [-SourceType <String>] [-WebUrl <String>]
