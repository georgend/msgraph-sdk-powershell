...
```
Update-MgUserProfileProject -ProjectParticipationId <String> -UserId <String> [-AllowedAudiences <String>]
 [-Categories <String[]>] [-ClientAddressCity <String>] [-ClientAddressCountryOrRegion <String>]
 [-ClientAddressPostalCode <String>] [-ClientAddressPostOfficeBox <String>] [-ClientAddressState <String>]
 [-ClientAddressStreet <String>] [-ClientAddressType <String>] [-ClientDepartment <String>]
 [-ClientDisplayName <String>] [-ClientOfficeLocation <String>] [-ClientPronunciation <String>]
 [-ClientWebUrl <String>] [-CollaborationTags <String[]>] [-Colleagues <IMicrosoftGraphRelatedPerson[]>]
 [-CompanyDepartment <String>] [-CompanyDisplayName <String>] [-CompanyOfficeLocation <String>]
 [-CompanyPronunciation <String>] [-CompanyWebUrl <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-DetailCompanyAddressCity <String>]
 [-DetailCompanyAddressCountryOrRegion <String>] [-DetailCompanyAddressPostalCode <String>]
 [-DetailCompanyAddressPostOfficeBox <String>] [-DetailCompanyAddressState <String>]
 [-DetailCompanyAddressStreet <String>] [-DetailCompanyAddressType <String>] [-DetailDescription <String>]
 [-DetailEndMonthYear <DateTime>] [-DetailJobTitle <String>] [-DetailRole <String>]
 [-DetailStartMonthYear <DateTime>] [-DetailSummary <String>] [-DisplayName <String>] [-Id <String>]
...
```
Update-MgUserProfileProject -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-Categories <String[]>] [-ClientAddressCity <String>] [-ClientAddressCountryOrRegion <String>]
 [-ClientAddressPostalCode <String>] [-ClientAddressPostOfficeBox <String>] [-ClientAddressState <String>]
 [-ClientAddressStreet <String>] [-ClientAddressType <String>] [-ClientDepartment <String>]
 [-ClientDisplayName <String>] [-ClientOfficeLocation <String>] [-ClientPronunciation <String>]
...
key: projectParticipation-id of projectParticipation
