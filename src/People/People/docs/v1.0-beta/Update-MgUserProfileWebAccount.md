...
```
Update-MgUserProfileWebAccount -UserId <String> -WebAccountId <String> [-AllowedAudiences <String>]
 ...
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-ServiceName <String>]
 [-ServiceWebUrl <String>] [-SourceType <String>] [-StatusMessage <String>] [-UserId1 <String>]
...
```
Update-MgUserProfileWebAccount -InputObject <IPeopleIdentity> [-UserId <String>] [-AllowedAudiences <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-Description <String>]
 [-Id <String>] [-InferenceConfidenceScore <Double>] [-InferenceUserHasVerifiedAccuracy]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-ServiceName <String>]
 [-ServiceWebUrl <String>] [-SourceType <String>] [-StatusMessage <String>] [-WebUrl <String>] [-PassThru]
...
### -WebAccountId
key: webAccount-id of webAccount
