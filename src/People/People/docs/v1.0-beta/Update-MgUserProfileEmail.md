...
```
Update-MgUserProfileEmail -ItemEmailId <String> -UserId <String> [-Address <String>]
 ...
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserProfileEmail -InputObject <IPeopleIdentity> [-Address <String>] [-AllowedAudiences <String>]
