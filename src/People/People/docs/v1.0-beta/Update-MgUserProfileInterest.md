...
```
Update-MgUserProfileInterest -PersonInterestId <String> -UserId <String> [-AllowedAudiences <String>]
...
```
Update-MgUserProfileInterest -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-Categories <String[]>] [-CollaborationTags <String[]>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-Description <String>] [-DisplayName <String>] [-Id <String>]
 [-InferenceConfidenceScore <Double>] [-InferenceUserHasVerifiedAccuracy]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-SourceType <String>]
...
### -PersonInterestId
key: personInterest-id of personInterest
