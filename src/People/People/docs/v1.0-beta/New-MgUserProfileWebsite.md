...
```
New-MgUserProfileWebsite -UserId <String> [-AllowedAudiences <String>] [-Categories <String[]>]
...
```
New-MgUserProfileWebsite -InputObject <IPeopleIdentity> [-AllowedAudiences <String>] [-Categories <String[]>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-Description <String>]
 [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-WebUrl <String>] [-Confirm] [-WhatIf]
