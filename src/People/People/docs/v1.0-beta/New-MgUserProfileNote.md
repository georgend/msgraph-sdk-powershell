...
```
New-MgUserProfileNote -UserId <String> [-AllowedAudiences <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <DateTime>] [-DetailContent <String>] [-DetailContentType <String>] [-DisplayName <String>]
...
```
New-MgUserProfileNote -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DetailContent <String>]
 [-DetailContentType <String>] [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
