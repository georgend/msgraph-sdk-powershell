...
```
New-MgUserProfilePhone -UserId <String> [-AllowedAudiences <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 ...
 [-LastModifiedDateTime <DateTime>] [-Number <String>] [-SourceType <String>] [-Type <String>] [-Confirm]
...
```
New-MgUserProfilePhone -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 ...
 [-SourceType <String>] [-Type <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
