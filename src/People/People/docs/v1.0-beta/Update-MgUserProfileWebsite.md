...
```
Update-MgUserProfileWebsite -PersonWebsiteId <String> -UserId <String> [-AllowedAudiences <String>]
 ...
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-WebUrl <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserProfileWebsite -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-Categories <String[]>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-Description <String>] [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-WebUrl <String>] [-PassThru] [-Confirm] [-WhatIf]
...
### -PersonWebsiteId
key: personWebsite-id of personWebsite
