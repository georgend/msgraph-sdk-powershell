...
```
Update-MgUserProfileNote -PersonAnnotationId <String> -UserId <String> [-AllowedAudiences <String>]
 ...
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserProfileNote -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DetailContent <String>]
 [-DetailContentType <String>] [-DisplayName <String>] [-Id <String>] [-InferenceConfidenceScore <Double>]
 [-InferenceUserHasVerifiedAccuracy] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-SourceType <String>] [-PassThru] [-Confirm] [-WhatIf]
...
### -PersonAnnotationId
key: personAnnotation-id of personAnnotation
