...
```
Update-MgUserProfileAddress -ItemAddressId <String> -UserId <String> [-AllowedAudiences <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DetailCity <String>]
 [-DetailCountryOrRegion <String>] [-DetailPostalCode <String>] [-DetailPostOfficeBox <String>]
 [-DetailState <String>] [-DetailStreet <String>] [-DetailType <String>] [-DisplayName <String>]
...
```
Update-MgUserProfileAddress -InputObject <IPeopleIdentity> [-AllowedAudiences <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DetailCity <String>]
 [-DetailCountryOrRegion <String>] [-DetailPostalCode <String>] [-DetailPostOfficeBox <String>]
 [-DetailState <String>] [-DetailStreet <String>] [-DetailType <String>] [-DisplayName <String>]
 [-GeoCoordinateAltitude <Double>] [-GeoCoordinateLatitude <Double>] [-GeoCoordinateLongitude <Double>]
...
### -ItemAddressId
key: itemAddress-id of itemAddress
