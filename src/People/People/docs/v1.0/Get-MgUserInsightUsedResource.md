...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguserinsightusedresource
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserInsightUsedResource -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
