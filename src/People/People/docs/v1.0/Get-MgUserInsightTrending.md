...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguserinsighttrending
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserInsightTrending -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
