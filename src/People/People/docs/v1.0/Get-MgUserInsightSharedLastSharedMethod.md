...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguserinsightsharedlastsharedmethod
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserInsightSharedLastSharedMethod -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>]
