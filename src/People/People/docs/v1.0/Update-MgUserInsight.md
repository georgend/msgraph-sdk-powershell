...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/update-mguserinsight
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserInsight -InputObject <IPeopleIdentity> -BodyParameter <IMicrosoftGraphOfficeGraphInsights>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserInsight -InputObject <IPeopleIdentity> [-Id <String>] [-Shared <IMicrosoftGraphSharedInsight[]>]
 [-Trending <IMicrosoftGraphTrending[]>] [-Used <IMicrosoftGraphUsedInsight[]>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
