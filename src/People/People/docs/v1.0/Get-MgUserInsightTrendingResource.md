...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mguserinsighttrendingresource
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserInsightTrendingResource -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
