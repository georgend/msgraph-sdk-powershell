...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.actions/add-mgsite
schema: 2.0.0
---
...
### AddExpanded (Default)
```
Add-MgSite [-Value <IMicrosoftGraphSite1[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Add
```
Add-MgSite -BodyParameter <IPathsV2U0Z1SitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsV2U0Z1SitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1
Parameter Sets: Add
Aliases:
...
### Microsoft.Graph.PowerShell.Models.IPathsV2U0Z1SitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1
...
BODYPARAMETER <IPathsV2U0Z1SitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1>: .
