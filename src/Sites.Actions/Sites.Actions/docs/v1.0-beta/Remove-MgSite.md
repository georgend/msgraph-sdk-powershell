...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites.actions/remove-mgsite
schema: 2.0.0
---
...
```
Remove-MgSite [-Value <IMicrosoftGraphSite1[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Remove
```
Remove-MgSite
 -BodyParameter <IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema1> [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema1
...
### Microsoft.Graph.PowerShell.Models.IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema1
...
BODYPARAMETER <IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema1>: .
        ...
        - `[Activities <IMicrosoftGraphItemActivityOld[]>]`: 
          ...
          - `[DriveItem <IMicrosoftGraphDriveItem>]`: driveItem
            ...
            - `[WorkbookNames <IMicrosoftGraphWorkbookNamedItem[]>]`: Represents a collection of workbook scoped named items (named ranges and constants). Read-only.
              ...
              - `[WorksheetTables <IMicrosoftGraphWorkbookTable[]>]`: Collection of tables that are part of the worksheet. Read-only.
              - `[WorksheetVisibility <String>]`: The Visibility of the worksheet. The possible values are: Visible, Hidden, VeryHidden.
            - `[WorkbookOperations <IMicrosoftGraphWorkbookOperation[]>]`: The status of workbook operations. Getting an operation collection is not supported, but you can get the status of a long-running operation if the Location header is returned in the response. Read-only.
              - `[Id <String>]`: Read-only.
