...
```
Remove-MgSite [-Value <IMicrosoftGraphSite[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Remove1
```
Remove-MgSite
 -BodyParameter <IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema> [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
Parameter Sets: RemoveExpanded1
Aliases:
...
### Microsoft.Graph.PowerShell.Models.IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
BODYPARAMETER <IPaths8Behs0SitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>: .
