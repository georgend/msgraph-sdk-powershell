...
```
New-MgUserOutlookTaskGroup -UserId <String> [-ChangeKey <String>] [-GroupKey <String>] [-Id <String>]
...
```
New-MgUserOutlookTaskGroup -InputObject <IUsersIdentity> [-ChangeKey <String>] [-GroupKey <String>]
 [-Id <String>] [-IsDefaultGroup] [-Name <String>] [-TaskFolders <IMicrosoftGraphOutlookTaskFolder[]>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
