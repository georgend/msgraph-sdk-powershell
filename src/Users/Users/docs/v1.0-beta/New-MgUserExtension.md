...
### CreateViaIdentity
```
New-MgUserExtension -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphExtension> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserExtension -InputObject <IUsersIdentity> [-Id <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
