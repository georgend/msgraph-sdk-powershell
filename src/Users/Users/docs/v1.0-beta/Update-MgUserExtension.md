...
### UpdateViaIdentity1
```
Update-MgUserExtension -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphExtension> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserExtension -InputObject <IUsersIdentity> [-Id <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
