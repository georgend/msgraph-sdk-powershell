...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/update-mguserapproleassignment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserAppRoleAssignment -InputObject <IUsersIdentity> -BodyParameter <IMicrosoftGraphAppRoleAssignment>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserAppRoleAssignment -InputObject <IUsersIdentity> [-AppRoleId <String>]
 [-CreatedDateTime <DateTime>] [-DeletedDateTime <DateTime>] [-Id <String>] [-PrincipalDisplayName <String>]
 [-PrincipalId <String>] [-PrincipalType <String>] [-ResourceDisplayName <String>] [-ResourceId <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
