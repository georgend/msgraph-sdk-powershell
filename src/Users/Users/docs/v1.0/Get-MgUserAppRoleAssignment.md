...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/get-mguserapproleassignment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserAppRoleAssignment -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
