...
New-MgTeamChannelMessage -ChannelId <String> -TeamId <String>
 ...
 [-ChannelIdentityChannelId <String>] [-ChannelIdentityTeamId <String>] [-ChatId <String>]
...
```
New-MgTeamChannelMessage -InputObject <ITeamsIdentity> [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
 [-BodyContent <String>] [-BodyContentType <String>] [-ChannelIdentityChannelId <String>]
 [-ChannelIdentityTeamId <String>] [-ChatId <String>] [-CreatedDateTime <DateTime>]
