...
New-MgTeamScheduleTimeOff -TeamId <String> [-CreatedDateTime <DateTime>] [-DraftTimeOffEndDateTime <DateTime>]
 ...
 [-LastModifiedDateTime <DateTime>] [-SharedTimeOffEndDateTime <DateTime>] [-SharedTimeOffReasonId <String>]
...
```
New-MgTeamScheduleTimeOff -InputObject <ITeamsIdentity> [-CreatedDateTime <DateTime>]
 [-DraftTimeOffEndDateTime <DateTime>] [-DraftTimeOffReasonId <String>]
 [-DraftTimeOffStartDateTime <DateTime>] [-DraftTimeOffTheme <String>] [-Id <String>] [-IsStagedForDeletion]
