...
Update-MgTeamPrimaryChannel -TeamId <String> [-Description <String>] [-DisplayName <String>] [-Email <String>]
 ...
 [-Messages <IMicrosoftGraphChatMessage1[]>] [-ModerationSettingAllowNewMessageFromBots]
 [-ModerationSettingAllowNewMessageFromConnectors] [-ModerationSettingReplyRestriction <String>]
 [-ModerationSettingUserNewMessageRestriction <String>] [-Tabs <IMicrosoftGraphTeamsTab1[]>]
...
```
Update-MgTeamPrimaryChannel -InputObject <ITeamsIdentity> [-Description <String>] [-DisplayName <String>]
...
### -ModerationSettingAllowNewMessageFromBots
.
...
### -ModerationSettingAllowNewMessageFromConnectors
.
...
### -ModerationSettingReplyRestriction
replyRestriction
...
### -ModerationSettingUserNewMessageRestriction
