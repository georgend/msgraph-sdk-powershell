...
```
New-MgChatMember -ChatId <String> [-DisplayName <String>] [-Id <String>] [-Roles <String[]>] [-Confirm]
...
```
New-MgChatMember -InputObject <ITeamsIdentity> [-DisplayName <String>] [-Id <String>] [-Roles <String[]>]
