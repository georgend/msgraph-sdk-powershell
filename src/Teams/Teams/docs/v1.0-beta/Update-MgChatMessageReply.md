...
Update-MgChatMessageReply -ChatId <String> -ChatMessageId <String> -ChatMessageId1 <String>
 ...
 [-ChannelIdentityChannelId <String>] [-ChannelIdentityTeamId <String>] [-ChatId1 <String>]
...
```
Update-MgChatMessageReply -InputObject <ITeamsIdentity> [-ChatId <String>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-BodyContent <String>] [-BodyContentType <String>]
 [-ChannelIdentityChannelId <String>] [-ChannelIdentityTeamId <String>] [-CreatedDateTime <DateTime>]
