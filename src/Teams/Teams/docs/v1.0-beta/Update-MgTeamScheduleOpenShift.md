...
Update-MgTeamScheduleOpenShift -OpenShiftId <String> -TeamId <String> [-CreatedDateTime <DateTime>]
 ...
 [-DraftOpenShiftTheme <String>] [-Id <String>] [-IsStagedForDeletion]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-SchedulingGroupId <String>] [-SharedOpenShiftActivities <IMicrosoftGraphShiftActivity[]>]
 [-SharedOpenShiftDisplayName <String>] [-SharedOpenShiftEndDateTime <DateTime>]
 [-SharedOpenShiftNotes <String>] [-SharedOpenShiftOpenSlotCount <Int32>]
 [-SharedOpenShiftStartDateTime <DateTime>] [-SharedOpenShiftTheme <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgTeamScheduleOpenShift -InputObject <ITeamsIdentity> [-CreatedDateTime <DateTime>]
 [-DraftOpenShiftActivities <IMicrosoftGraphShiftActivity[]>] [-DraftOpenShiftDisplayName <String>]
 [-DraftOpenShiftEndDateTime <DateTime>] [-DraftOpenShiftNotes <String>]
 [-DraftOpenShiftOpenSlotCount <Int32>] [-DraftOpenShiftStartDateTime <DateTime>]
 [-DraftOpenShiftTheme <String>] [-Id <String>] [-IsStagedForDeletion]
