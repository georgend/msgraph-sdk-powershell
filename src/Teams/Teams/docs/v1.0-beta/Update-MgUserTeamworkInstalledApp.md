...
Update-MgUserTeamworkInstalledApp -UserId <String> -UserScopeTeamsAppInstallationId <String>
 [-ChatCreatedDateTime <DateTime>] [-ChatId <String>]
 ...
 [-TeamAppDistributionMethod <String>] [-TeamAppExternalId <String>] [-TeamAppId <String>] [-PassThru]
...
```
Update-MgUserTeamworkInstalledApp -InputObject <ITeamsIdentity> [-ChatCreatedDateTime <DateTime>]
...
key: userScopeTeamsAppInstallation-id of userScopeTeamsAppInstallation
