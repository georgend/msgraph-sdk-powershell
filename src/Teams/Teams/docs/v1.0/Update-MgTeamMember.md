...
```
Update-MgTeamMember -ConversationMemberId <String> -TeamId <String> [-DisplayName <String>] [-Id <String>]
...
```
Update-MgTeamMember -InputObject <ITeamsIdentity> [-DisplayName <String>] [-Id <String>] [-Roles <String[]>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
