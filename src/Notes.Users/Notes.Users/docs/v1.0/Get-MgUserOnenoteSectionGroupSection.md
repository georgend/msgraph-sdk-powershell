...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectiongroupsection
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserOnenoteSectionGroupSection -SectionGroupId <String> -UserId <String> [-Count]
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionGroupSection -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
