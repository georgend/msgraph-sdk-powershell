...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentsectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenotePageParentSectionParentNotebook -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
