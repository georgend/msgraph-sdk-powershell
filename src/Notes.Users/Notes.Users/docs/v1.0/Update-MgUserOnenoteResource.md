...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/update-mguseronenoteresource
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgUserOnenoteResource -InputObject <INotesUsersIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserOnenoteResource -InputObject <INotesUsersIdentity> [-ContentInputFile <String>]
 [-ContentUrl <String>] [-Id <String>] [-Self <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
