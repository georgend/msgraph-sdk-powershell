...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotenotebooksectionparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionParentSectionGroup -InputObject <INotesUsersIdentity>
