...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/update-mguseronenotesectiongroupsection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgUserOnenoteSectionGroupSection -InputObject <INotesUsersIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
