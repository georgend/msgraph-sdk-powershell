...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionpageparentsection
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionPageParentSection -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
