...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Get-MgUserOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup
 -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
