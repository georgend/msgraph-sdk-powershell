...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenotepageparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgUserOnenotePageParentNotebookSectionParentSectionGroup -InputObject <INotesUsersIdentity>
