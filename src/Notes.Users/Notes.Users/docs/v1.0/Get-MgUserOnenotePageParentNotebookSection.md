...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSection -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
