...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectiongroupsectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgUserOnenoteSectionGroupSectionPageParentNotebookSectionGroup -OnenotePageId <String>
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionGroupSectionPageParentNotebookSectionGroup -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
