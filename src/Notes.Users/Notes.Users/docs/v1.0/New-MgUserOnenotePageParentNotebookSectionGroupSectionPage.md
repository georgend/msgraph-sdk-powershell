...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenotepageparentnotebooksectiongroupsectionpage
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserOnenotePageParentNotebookSectionGroupSectionPage -InputObject <INotesUsersIdentity>
