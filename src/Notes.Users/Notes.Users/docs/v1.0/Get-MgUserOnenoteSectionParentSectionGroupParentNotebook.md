...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionParentSectionGroupParentNotebook -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
