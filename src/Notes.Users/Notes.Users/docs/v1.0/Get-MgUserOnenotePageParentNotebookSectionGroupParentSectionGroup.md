...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionGroupParentSectionGroup -InputObject <INotesUsersIdentity>
