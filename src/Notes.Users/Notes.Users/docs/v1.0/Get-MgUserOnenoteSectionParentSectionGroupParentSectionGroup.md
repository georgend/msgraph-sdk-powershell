...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenoteSectionParentSectionGroupParentSectionGroup -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
