...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenotepageparentnotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgUserOnenotePageParentNotebookSectionParentSectionGroupSection -InputObject <INotesUsersIdentity>
