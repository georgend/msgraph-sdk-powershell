...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenoteoperation
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserOnenoteOperation -InputObject <INotesUsersIdentity> -BodyParameter <IMicrosoftGraphOnenoteOperation>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserOnenoteOperation -InputObject <INotesUsersIdentity> [-Code <String>] [-CreatedDateTime <DateTime>]
