...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionGroupParentNotebook -InputObject <INotesUsersIdentity>
