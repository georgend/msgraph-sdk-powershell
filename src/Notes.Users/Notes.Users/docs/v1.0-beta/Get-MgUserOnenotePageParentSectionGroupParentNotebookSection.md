...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionGroupParentNotebookSection -InputObject <INotesUsersIdentity>
