...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionParentNotebook -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
