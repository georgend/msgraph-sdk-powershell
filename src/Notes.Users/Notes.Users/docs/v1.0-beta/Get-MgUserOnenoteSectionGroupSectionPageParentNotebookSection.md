...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
