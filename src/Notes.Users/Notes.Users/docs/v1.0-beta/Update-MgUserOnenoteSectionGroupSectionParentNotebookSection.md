...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/update-mguseronenotesectiongroupsectionparentnotebooksection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserOnenoteSectionGroupSectionParentNotebookSection -InputObject <INotesUsersIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
