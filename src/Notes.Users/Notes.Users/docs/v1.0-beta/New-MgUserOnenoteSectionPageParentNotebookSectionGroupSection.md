...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <INotesUsersIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
