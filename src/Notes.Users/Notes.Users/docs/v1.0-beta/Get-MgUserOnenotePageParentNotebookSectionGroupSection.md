...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenotePageParentNotebookSectionGroupSection -InputObject <INotesUsersIdentity>
