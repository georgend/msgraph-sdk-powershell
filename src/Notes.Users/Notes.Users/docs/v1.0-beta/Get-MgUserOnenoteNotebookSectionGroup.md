...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotenotebooksectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionGroup -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
