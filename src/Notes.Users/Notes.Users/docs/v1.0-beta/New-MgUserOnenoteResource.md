...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenoteresource
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserOnenoteResource -InputObject <INotesUsersIdentity> -BodyParameter <IMicrosoftGraphOnenoteResource>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserOnenoteResource -InputObject <INotesUsersIdentity> [-ContentInputFile <String>]
