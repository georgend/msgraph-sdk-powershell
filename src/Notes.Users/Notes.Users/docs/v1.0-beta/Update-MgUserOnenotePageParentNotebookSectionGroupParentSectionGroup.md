...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/update-mguseronenotepageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgUserOnenotePageParentNotebookSectionGroupParentSectionGroup -InputObject <INotesUsersIdentity>
