...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserOnenoteSectionParentNotebookSectionGroupSection -OnenoteSectionId <String> -SectionGroupId <String>
...
### Get
```
Get-MgUserOnenoteSectionParentNotebookSectionGroupSection -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionParentNotebookSectionGroupSection -InputObject <INotesUsersIdentity>
