...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenoteoperation
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenoteOperation -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
