...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectiongroupsectionpage
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSectionPage -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
