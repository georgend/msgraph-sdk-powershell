...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectiongroup
schema: 2.0.0
---
...
### GetViaIdentity2
```
Get-MgUserOnenotePageParentNotebookSectionGroup -InputObject <INotesUsersIdentity>
