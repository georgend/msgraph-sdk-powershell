...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
