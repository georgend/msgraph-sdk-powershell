...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentsectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionGroupSection -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
