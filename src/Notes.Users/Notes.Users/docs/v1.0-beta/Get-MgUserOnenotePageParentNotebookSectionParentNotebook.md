...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentNotebookSectionParentNotebook -InputObject <INotesUsersIdentity>
