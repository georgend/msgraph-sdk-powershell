...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionGroupSectionPageParentNotebook -InputObject <INotesUsersIdentity>
