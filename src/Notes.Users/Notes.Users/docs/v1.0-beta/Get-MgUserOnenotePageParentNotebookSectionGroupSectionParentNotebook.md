...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentnotebooksectiongroupsectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserOnenotePageParentNotebookSectionGroupSectionParentNotebook -InputObject <INotesUsersIdentity>
