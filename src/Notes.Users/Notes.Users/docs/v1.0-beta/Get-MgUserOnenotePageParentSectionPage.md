...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentsectionpage
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionPage -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
