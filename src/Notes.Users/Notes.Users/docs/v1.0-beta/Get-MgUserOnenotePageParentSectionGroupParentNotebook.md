...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotepageparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenotePageParentSectionGroupParentNotebook -InputObject <INotesUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
