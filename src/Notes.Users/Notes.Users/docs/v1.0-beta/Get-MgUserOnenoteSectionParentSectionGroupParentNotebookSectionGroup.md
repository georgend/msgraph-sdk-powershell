...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionparentsectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionParentSectionGroupParentNotebookSectionGroup -InputObject <INotesUsersIdentity>
