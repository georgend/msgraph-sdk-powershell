...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotenotebooksectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteNotebookSectionGroupSection -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
