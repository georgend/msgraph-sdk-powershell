...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionParentNotebookSection -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
