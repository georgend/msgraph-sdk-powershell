...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/update-mguseronenotepageparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserOnenotePageParentNotebookSectionParentNotebook -InputObject <INotesUsersIdentity>
