...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenotesectiongroupsectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionGroupSectionPageParentNotebookSectionGroup -InputObject <INotesUsersIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
