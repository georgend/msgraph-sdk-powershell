...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/get-mguseronenotesectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserOnenoteSectionPageParentNotebook -InputObject <INotesUsersIdentity> [-ExpandProperty <String[]>]
