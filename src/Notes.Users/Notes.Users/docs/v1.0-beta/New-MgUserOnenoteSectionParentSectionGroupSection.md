...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.users/new-mguseronenotesectionparentsectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserOnenoteSectionParentSectionGroupSection -InputObject <INotesUsersIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
