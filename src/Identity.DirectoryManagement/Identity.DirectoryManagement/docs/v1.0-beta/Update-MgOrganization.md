...
Update-MgOrganization -OrganizationId <String> [-AssignedPlans <IMicrosoftGraphAssignedPlan[]>]
 ...
 [-IsMultipleDataLocationsForServicesEnabled] [-ItemInsightDisabledForGroup <String>]
 [-ItemInsightId <String>] [-ItemInsightIsEnabledInOrganization] [-MarketingNotificationEmails <String[]>]
 ...
 [-SettingId <String>] [-SettingProfileCardProperties <IMicrosoftGraphProfileCardProperty[]>]
...
### -ItemInsightIsEnabledInOrganization
.
...
### -SettingProfileCardProperties
.
To construct, see NOTES section for SETTINGPROFILECARDPROPERTIES properties and create a hash table.
...
BODYPARAMETER <IMicrosoftGraphOrganization1>: The organization resource represents an instance of global settings and resources which operate and are provisioned at the tenant-level.
  ...
  - `[ItemInsightDisabledForGroup <String>]`: 
  - `[ItemInsightId <String>]`: Read-only.
  - `[ItemInsightIsEnabledInOrganization <Boolean?>]`: 
  ...
  - `[SettingProfileCardProperties <IMicrosoftGraphProfileCardProperty[]>]`: 
    - `[Id <String>]`: Read-only.
