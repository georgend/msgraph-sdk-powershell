...
```
Update-MgDeviceCommand -InputObject <IIdentityDirectoryManagementIdentity> [-AppServiceName <String>]
 [-Error <String>] [-Id <String>] [-PackageFamilyName <String>] [-Payload <IMicrosoftGraphPayloadRequest>]
 [-PermissionTicket <String>] [-PostBackUri <String>] [-ResponsepayloadId <String>] [-Status <String>]
 [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
