...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directorymanagement/remove-mgcontactorgcontact
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgContactOrgContact -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>] [-PassThru]
