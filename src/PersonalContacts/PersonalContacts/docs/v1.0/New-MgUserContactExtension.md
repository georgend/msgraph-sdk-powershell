...
### CreateViaIdentity1
```
New-MgUserContactExtension -InputObject <IPersonalContactsIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserContactExtension -InputObject <IPersonalContactsIdentity> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
