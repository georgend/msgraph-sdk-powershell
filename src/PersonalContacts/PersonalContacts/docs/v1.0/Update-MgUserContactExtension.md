...
```
Update-MgUserContactExtension -ContactId <String> -ExtensionId <String> -UserId <String> [-Id <String>]
...
```
Update-MgUserContactExtension -InputObject <IPersonalContactsIdentity> [-Id <String>] [-PassThru] [-Confirm]
