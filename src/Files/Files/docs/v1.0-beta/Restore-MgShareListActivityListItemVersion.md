...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/restore-mgsharelistactivitylistitemversion
schema: 2.0.0
---
...
### RestoreViaIdentity
```
Restore-MgShareListActivityListItemVersion -InputObject <IFilesIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
