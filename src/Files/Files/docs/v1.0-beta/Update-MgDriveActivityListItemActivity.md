...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgdriveactivitylistitemactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDriveActivityListItemActivity -InputObject <IFilesIdentity>
