...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mgdrivelistactivitylistitemactivity
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgDriveListActivityListItemActivity -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-Confirm] [-WhatIf] [<CommonParameters>]
```
