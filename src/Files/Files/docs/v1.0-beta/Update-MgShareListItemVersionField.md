...
### UpdateViaIdentity
```
Update-MgShareListItemVersionField -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphFieldValueSet>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgShareListItemVersionField -InputObject <IFilesIdentity> [-Id <String>] [-PassThru] [-Confirm]
