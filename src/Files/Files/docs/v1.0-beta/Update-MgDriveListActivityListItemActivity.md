...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgdrivelistactivitylistitemactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDriveListActivityListItemActivity -InputObject <IFilesIdentity>
