...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgsharelistactivitylistitemactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgShareListActivityListItemActivity -InputObject <IFilesIdentity>
