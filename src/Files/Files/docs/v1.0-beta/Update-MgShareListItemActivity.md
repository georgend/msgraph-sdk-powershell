...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgsharelistitemactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgShareListItemActivity -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgShareListItemActivity -InputObject <IFilesIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
