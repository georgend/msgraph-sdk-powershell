...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgdrivelistactivitylistitemversion
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDriveListActivityListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgDriveListActivityListItemVersion -InputObject <IFilesIdentity> [-FieldId <String>] [-Id <String>]
