...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/get-mgdrivelistactivitylistitemversionfield
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDriveListActivityListItemVersionField -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]
