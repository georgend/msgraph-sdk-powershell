...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mgdrivelistactivitylistitemversion
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgDriveListActivityListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgDriveListActivityListItemVersion -InputObject <IFilesIdentity> [-FieldId <String>] [-Id <String>]
