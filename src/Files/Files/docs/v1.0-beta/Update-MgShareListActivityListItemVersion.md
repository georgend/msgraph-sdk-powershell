...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgsharelistactivitylistitemversion
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgShareListActivityListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgShareListActivityListItemVersion -InputObject <IFilesIdentity> [-FieldId <String>] [-Id <String>]
