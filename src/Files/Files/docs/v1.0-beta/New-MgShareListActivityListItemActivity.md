...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mgsharelistactivitylistitemactivity
schema: 2.0.0
---
...
```
New-MgShareListActivityListItemActivity -ItemActivityOldId <String> -SharedDriveItemId <String>
...
### CreateViaIdentity
```
New-MgShareListActivityListItemActivity -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-Confirm] [-WhatIf] [<CommonParameters>]
```
