...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgdrivelistitemactivity
schema: 2.0.0
---
...
```
Update-MgDriveListItemActivity -DriveId <String> -ItemActivityOldId <String> -ListItemId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListItemActivity -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgDriveListItemActivity -InputObject <IFilesIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
