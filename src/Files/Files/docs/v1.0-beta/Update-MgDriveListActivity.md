...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgdrivelistactivity
schema: 2.0.0
---

# Update-MgDriveListActivity
...
```
Update-MgDriveListActivity -DriveId <String> -ItemActivityOldId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListActivity -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgDriveListActivity -InputObject <IFilesIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
