...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mgsharelistactivitylistitemversion
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgShareListActivityListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgShareListActivityListItemVersion -InputObject <IFilesIdentity> [-FieldId <String>] [-Id <String>]
