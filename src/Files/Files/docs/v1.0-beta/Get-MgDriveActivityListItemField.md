...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/get-mgdriveactivitylistitemfield
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDriveActivityListItemField -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
