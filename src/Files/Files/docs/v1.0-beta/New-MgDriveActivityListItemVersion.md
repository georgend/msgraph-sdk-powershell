...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mgdriveactivitylistitemversion
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgDriveActivityListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgDriveActivityListItemVersion -InputObject <IFilesIdentity> [-FieldId <String>] [-Id <String>]
