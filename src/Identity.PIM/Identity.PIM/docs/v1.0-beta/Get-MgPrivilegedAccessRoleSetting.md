...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.pim/get-mgprivilegedaccessrolesetting
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgPrivilegedAccessRoleSetting -InputObject <IIdentityPimIdentity> [-ExpandProperty <String[]>]
