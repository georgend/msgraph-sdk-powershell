...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.pim/get-mgprivilegedaccessroleassignment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgPrivilegedAccessRoleAssignment -InputObject <IIdentityPimIdentity> [-ExpandProperty <String[]>]
