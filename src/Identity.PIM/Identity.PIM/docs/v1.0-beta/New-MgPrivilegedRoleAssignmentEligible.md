...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.pim/new-mgprivilegedroleassignmenteligible
schema: 2.0.0
---
...
### MakeViaIdentity
```
New-MgPrivilegedRoleAssignmentEligible -InputObject <IIdentityPimIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
