...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.pim/remove-mgprivilegedrole
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgPrivilegedRole -InputObject <IIdentityPimIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
