...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.pim/get-mgprivilegedrolesummary
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgPrivilegedRoleSummary -InputObject <IIdentityPimIdentity> [-ExpandProperty <String[]>]
