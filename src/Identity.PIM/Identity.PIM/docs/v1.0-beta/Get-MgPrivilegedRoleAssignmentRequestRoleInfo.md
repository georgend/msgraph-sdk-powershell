...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.pim/get-mgprivilegedroleassignmentrequestroleinfo
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgPrivilegedRoleAssignmentRequestRoleInfo -InputObject <IIdentityPimIdentity> [-ExpandProperty <String[]>]
