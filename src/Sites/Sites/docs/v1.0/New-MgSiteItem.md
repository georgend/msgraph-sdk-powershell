...
### Create
```
New-MgSiteItem -SiteId <String> -BodyParameter <IMicrosoftGraphBaseItem> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteItem -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphBaseItem> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
