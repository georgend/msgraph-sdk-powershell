...
Update-MgSiteItem -BaseItemId <String> -SiteId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedByUser <IMicrosoftGraphUser>] [-CreatedDateTime <DateTime>] [-Description <String>] [-ETag <String>]
...
### Update
```
Update-MgSiteItem -BaseItemId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphBaseItem> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgSiteItem -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphBaseItem> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphBaseItem
...
BODYPARAMETER <IMicrosoftGraphBaseItem>: baseItem
  - `[Id <String>]`: Read-only.
