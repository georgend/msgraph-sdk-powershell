...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/new-mgsitelistactivitylistitemactivity
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteListActivityListItemActivity -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityOld> [-Confirm] [-WhatIf] [<CommonParameters>]
```
