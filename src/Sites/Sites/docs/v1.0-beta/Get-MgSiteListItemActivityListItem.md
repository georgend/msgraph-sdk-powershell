...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mgsitelistitemactivitylistitem
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListItemActivityListItem -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
