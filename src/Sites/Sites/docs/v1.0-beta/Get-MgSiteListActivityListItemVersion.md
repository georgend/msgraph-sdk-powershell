...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mgsitelistactivitylistitemversion
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListActivityListItemVersion -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
