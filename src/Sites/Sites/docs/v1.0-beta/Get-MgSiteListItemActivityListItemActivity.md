...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mgsitelistitemactivitylistitemactivity
schema: 2.0.0
---

# Get-MgSiteListItemActivityListItemActivity
...
### Get (Default)
```
Get-MgSiteListItemActivityListItemActivity -EndDateTime <String> -Interval <String>
...
### GetViaIdentity
```
Get-MgSiteListItemActivityListItemActivity -InputObject <ISitesIdentity> [<CommonParameters>]
```
