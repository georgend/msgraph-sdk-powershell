...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/invoke-mgpreviewsiteonenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---

# Invoke-MgPreviewSiteOnenoteSectionGroupParentNotebookSectionPage
...
### Preview (Default)
```
Invoke-MgPreviewSiteOnenoteSectionGroupParentNotebookSectionPage -OnenotePageId <String>
 -OnenoteSectionId <String> -SectionGroupId <String> -SiteId <String> [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewSiteOnenoteSectionGroupParentNotebookSectionPage -InputObject <ISitesIdentity>
 [<CommonParameters>]
```
