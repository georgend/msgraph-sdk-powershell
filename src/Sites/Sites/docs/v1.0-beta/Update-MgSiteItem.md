...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mgsiteitem
schema: 2.0.0
---
...
```
Update-MgSiteItem -BaseItemId <String> -SiteId <String> [-CreatedBy <IMicrosoftGraphIdentitySet>]
 ...
 [-ParentReference <IMicrosoftGraphItemReference>] [-WebUrl <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update1
```
Update-MgSiteItem -BaseItemId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphBaseItem1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity1
```
Update-MgSiteItem -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphBaseItem1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgSiteItem -InputObject <ISitesIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedByUser <IMicrosoftGraphUser1>] [-CreatedDateTime <DateTime>] [-Description <String>]
 [-ETag <String>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedByUser <IMicrosoftGraphUser1>] [-LastModifiedDateTime <DateTime>] [-Name <String>]
 [-ParentReference <IMicrosoftGraphItemReference>] [-WebUrl <String>] [-PassThru] [-Confirm] [-WhatIf]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphBaseItem1
...
BODYPARAMETER <IMicrosoftGraphBaseItem1>: baseItem
  - `[Id <String>]`: Read-only.
  ...
  - `[CreatedByUser <IMicrosoftGraphUser1>]`: Represents an Azure Active Directory user object.
    ...
    - `[Drive <IMicrosoftGraphDrive1>]`: drive
      ...
      - `[Activities <IMicrosoftGraphItemActivityOld[]>]`: 
        ...
        - `[DriveItem <IMicrosoftGraphDriveItem1>]`: driveItem
          ...
          - `[HashSha256Hash <String>]`: SHA256 hash for the contents of the file (if available). Read-only.
          ...
          - `[PendingContentUpdateQueuedDateTime <DateTime?>]`: Date and time the pending binary operation was queued in UTC time. Read-only.
          ...
          - `[PhotoOrientation <Int32?>]`: The orientation value from the camera. Writable on OneDrive Personal.
          ...
          - `[WorkbookNames <IMicrosoftGraphWorkbookNamedItem1[]>]`: Represents a collection of workbook scoped named items (named ranges and constants). Read-only.
            ...
            - `[WorksheetTables <IMicrosoftGraphWorkbookTable1[]>]`: Collection of tables that are part of the worksheet. Read-only.
            - `[WorksheetVisibility <String>]`: The Visibility of the worksheet. The possible values are: Visible, Hidden, VeryHidden.
          - `[WorkbookOperations <IMicrosoftGraphWorkbookOperation1[]>]`: The status of workbook operations. Getting an operation collection is not supported, but you can get the status of a long-running operation if the Location header is returned in the response. Read-only.
            - `[Id <String>]`: Read-only.
      ...
      - `[Quota <IMicrosoftGraphQuota>]`: quota
        ...
        - `[StoragePlanInformationUpgradeAvailable <Boolean?>]`: Indicates whether there are higher storage quota plans available. Read-only.
    ...
    - `[JoinedGroups <IMicrosoftGraphGroup1[]>]`: 
      ...
      - `[Team <IMicrosoftGraphTeam1>]`: team
        ...
        - `[Channels <IMicrosoftGraphChannel1[]>]`: The collection of channels & messages associated with the team.
          ...
          - `[ModerationSettingAllowNewMessageFromBots <Boolean?>]`: 
          - `[ModerationSettingAllowNewMessageFromConnectors <Boolean?>]`: 
          - `[ModerationSettingReplyRestriction <String>]`: replyRestriction
          - `[ModerationSettingUserNewMessageRestriction <String>]`: userNewMessageRestriction
    ...
    - `[MailboxSettings <IMicrosoftGraphMailboxSettings1>]`: mailboxSettings
      ...
      - `[UserPurposeValue <String>]`: mailboxRecipientType
    ...
    - `[PendingAccessReviewInstances <IMicrosoftGraphAccessReviewInstance[]>]`: 
      ...
      - `[DefinitionCreatedDateTime <DateTime?>]`: 
      - `[DefinitionDescriptionForAdmins <String>]`: 
      - `[DefinitionDescriptionForReviewers <String>]`: 
      - `[DefinitionDisplayName <String>]`: 
      - `[DefinitionId <String>]`: Read-only.
      - `[DefinitionInstances <IMicrosoftGraphAccessReviewInstance[]>]`: 
      - `[DefinitionLastModifiedDateTime <DateTime?>]`: 
      - `[DefinitionReviewers <IMicrosoftGraphAccessReviewScope[]>]`: 
        - `[Query <String>]`: 
        - `[QueryType <String>]`: 
      - `[DefinitionSettings <IMicrosoftGraphAccessReviewScheduleSettings>]`: accessReviewScheduleSettings
    ...
    - `[Teamwork <IMicrosoftGraphUserTeamwork>]`: userTeamwork
      ...
      - `[InstalledApps <IMicrosoftGraphUserScopeTeamsAppInstallation[]>]`: The apps installed in the personal scope of this user.
        ...
        - `[ChatMessages <IMicrosoftGraphChatMessage[]>]`: 
        - `[ChatTopic <String>]`: 
    - `[TransitiveMemberOf <IMicrosoftGraphDirectoryObject[]>]`: 
