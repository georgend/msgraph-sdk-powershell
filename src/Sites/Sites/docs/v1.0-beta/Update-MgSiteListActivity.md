...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mgsitelistactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteListActivity -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteListActivity -InputObject <ISitesIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
