...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/invoke-mgpreviewsiteonenotepageparentnotebooksectionpage
schema: 2.0.0
---

# Invoke-MgPreviewSiteOnenotePageParentNotebookSectionPage
...
### Preview (Default)
```
Invoke-MgPreviewSiteOnenotePageParentNotebookSectionPage -OnenotePageId <String> -OnenotePageId1 <String>
 -OnenoteSectionId <String> -SiteId <String> [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewSiteOnenotePageParentNotebookSectionPage -InputObject <ISitesIdentity> [<CommonParameters>]
```
