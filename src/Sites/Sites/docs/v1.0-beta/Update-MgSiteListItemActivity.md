...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mgsitelistitemactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteListItemActivity -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphItemActivityOld>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteListItemActivity -InputObject <ISitesIdentity> [-ActionCreate <IMicrosoftGraphCreateAction>]
