...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mgsitelistitemactivitydriveitem
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListItemActivityDriveItem -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
