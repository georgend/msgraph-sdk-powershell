...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mgsitelistactivitydriveitem
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteListActivityDriveItem -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
