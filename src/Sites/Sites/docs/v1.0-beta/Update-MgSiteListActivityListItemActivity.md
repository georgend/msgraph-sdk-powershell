...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mgsitelistactivitylistitemactivity
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteListActivityListItemActivity -InputObject <ISitesIdentity>
