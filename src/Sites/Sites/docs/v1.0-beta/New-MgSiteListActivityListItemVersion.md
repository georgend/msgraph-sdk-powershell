...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/new-mgsitelistactivitylistitemversion
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteListActivityListItemVersion -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteListActivityListItemVersion -InputObject <ISitesIdentity> [-FieldId <String>] [-Id <String>]
