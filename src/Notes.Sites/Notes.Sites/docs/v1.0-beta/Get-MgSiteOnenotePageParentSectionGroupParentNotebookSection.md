...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentSectionGroupParentNotebookSection -InputObject <INotesSitesIdentity>
