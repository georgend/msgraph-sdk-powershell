...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionPage -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgSiteOnenoteNotebookSectionPage -InputObject <INotesSitesIdentity> [-ContentInputFile <String>]
