...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionpageparentsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionPageParentSection -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
