...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenoteoperation
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenoteOperation -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphOnenoteOperation>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgSiteOnenoteOperation -InputObject <INotesSitesIdentity> [-Code <String>] [-CreatedDateTime <DateTime>]
