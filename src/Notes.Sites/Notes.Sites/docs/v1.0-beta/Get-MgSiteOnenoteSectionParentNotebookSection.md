...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentNotebookSection -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
