...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectiongroupsectionparentnotebooksectiongroup
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupSectionParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
