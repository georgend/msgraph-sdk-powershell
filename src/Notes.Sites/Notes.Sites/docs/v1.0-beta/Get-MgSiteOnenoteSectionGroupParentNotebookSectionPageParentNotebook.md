...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectiongroupparentnotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentNotebook -InputObject <INotesSitesIdentity>
