...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenotePageParentNotebookSection -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
