...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionPage -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
