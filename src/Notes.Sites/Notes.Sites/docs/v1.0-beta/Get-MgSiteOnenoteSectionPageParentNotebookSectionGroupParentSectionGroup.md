...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionpageparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionPageParentNotebookSectionGroupParentSectionGroup -InputObject <INotesSitesIdentity>
