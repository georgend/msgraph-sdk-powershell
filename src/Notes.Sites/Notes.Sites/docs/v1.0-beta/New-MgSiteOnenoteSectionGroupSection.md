...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotesectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionGroupSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
