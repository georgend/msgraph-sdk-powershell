...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotesectionparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionParentSectionGroupParentNotebookSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
