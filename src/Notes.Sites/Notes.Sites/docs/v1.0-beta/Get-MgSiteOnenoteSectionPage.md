...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionpage
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionPage -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
