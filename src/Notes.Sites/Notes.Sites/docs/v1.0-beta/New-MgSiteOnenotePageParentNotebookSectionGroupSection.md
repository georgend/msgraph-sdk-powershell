...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentNotebookSectionGroupSection -InputObject <INotesSitesIdentity>
