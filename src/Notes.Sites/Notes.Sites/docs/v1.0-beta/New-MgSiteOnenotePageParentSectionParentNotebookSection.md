...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentsectionparentnotebooksection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenotePageParentSectionParentNotebookSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm] [-WhatIf] [<CommonParameters>]
```
