...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotesectionparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionParentNotebookSectionGroupSection -InputObject <INotesSitesIdentity>
