...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroupParentSectionGroup -InputObject <INotesSitesIdentity>
