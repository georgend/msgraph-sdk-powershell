...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <INotesSitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
