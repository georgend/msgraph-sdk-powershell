...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteSectionGroupSection -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
