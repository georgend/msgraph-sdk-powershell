...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentsectiongroupparentnotebooksection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentSectionGroupParentNotebookSection -InputObject <INotesSitesIdentity>
