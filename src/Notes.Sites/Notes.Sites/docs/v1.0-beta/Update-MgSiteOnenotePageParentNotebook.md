...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenotePageParentNotebook -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
