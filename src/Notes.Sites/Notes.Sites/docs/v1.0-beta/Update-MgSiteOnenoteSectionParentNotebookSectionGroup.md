...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectionparentnotebooksectiongroup
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
