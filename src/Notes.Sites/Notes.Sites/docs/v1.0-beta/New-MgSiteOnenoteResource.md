...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenoteresource
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenoteResource -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphOnenoteResource>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteOnenoteResource -InputObject <INotesSitesIdentity> [-ContentInputFile <String>]
