...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentsectionparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenotePageParentSectionParentNotebookSectionGroupSection -InputObject <INotesSitesIdentity>
