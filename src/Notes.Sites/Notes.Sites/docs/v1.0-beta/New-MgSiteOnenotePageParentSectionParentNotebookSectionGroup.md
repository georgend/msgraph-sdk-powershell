...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentsectionparentnotebooksectiongroup
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenotePageParentSectionParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
