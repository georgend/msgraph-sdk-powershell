...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectiongroupsection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
