...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectiongroupparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupParentNotebook -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
