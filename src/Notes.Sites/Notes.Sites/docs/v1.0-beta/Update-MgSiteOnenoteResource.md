...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenoteresource
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteResource -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteOnenoteResource -InputObject <INotesSitesIdentity> [-ContentInputFile <String>]
 [-ContentUrl <String>] [-Id <String>] [-Self <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
