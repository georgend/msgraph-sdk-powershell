...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotenotebooksectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenoteNotebookSectionPageParentNotebook -InputObject <INotesSitesIdentity>
