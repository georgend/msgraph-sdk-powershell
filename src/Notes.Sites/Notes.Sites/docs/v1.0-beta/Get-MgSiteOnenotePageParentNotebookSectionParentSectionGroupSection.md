...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentnotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenotePageParentNotebookSectionParentSectionGroupSection -InputObject <INotesSitesIdentity>
