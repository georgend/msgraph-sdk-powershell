...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentnotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroupSection -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroupSection -InputObject <INotesSitesIdentity>
