...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroupSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
