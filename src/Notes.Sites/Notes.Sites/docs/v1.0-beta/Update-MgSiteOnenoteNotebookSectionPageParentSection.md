...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotenotebooksectionpageparentsection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionPageParentSection -InputObject <INotesSitesIdentity>
