...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotenotebooksectionparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionParentNotebook -InputObject <INotesSitesIdentity>
