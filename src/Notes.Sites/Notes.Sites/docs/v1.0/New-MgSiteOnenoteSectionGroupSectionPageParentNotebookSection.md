...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotesectiongroupsectionpageparentnotebooksection
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenoteSectionGroupSectionPageParentNotebookSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
