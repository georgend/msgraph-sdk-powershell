...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectiongroupsectionparentnotebooksection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupSectionParentNotebookSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
