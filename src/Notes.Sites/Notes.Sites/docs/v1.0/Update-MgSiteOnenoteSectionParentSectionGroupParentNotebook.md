...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionParentSectionGroupParentNotebook -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
