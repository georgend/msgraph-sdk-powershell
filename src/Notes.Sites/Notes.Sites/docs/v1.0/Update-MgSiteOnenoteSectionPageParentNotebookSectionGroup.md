...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectionpageparentnotebooksectiongroup
schema: 2.0.0
---
...
### UpdateViaIdentity2
```
Update-MgSiteOnenoteSectionPageParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
