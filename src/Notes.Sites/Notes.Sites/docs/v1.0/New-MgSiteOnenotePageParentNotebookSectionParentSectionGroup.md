...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentnotebooksectionparentsectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphSectionGroup1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgSiteOnenotePageParentNotebookSectionParentSectionGroup -InputObject <INotesSitesIdentity>
