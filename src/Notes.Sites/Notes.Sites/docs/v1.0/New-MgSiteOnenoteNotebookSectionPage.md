...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenoteNotebookSectionPage -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteOnenoteNotebookSectionPage -InputObject <INotesSitesIdentity> [-ContentInputFile <String>]
