...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenote
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenote -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphOnenote1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgSiteOnenote -InputObject <INotesSitesIdentity> [-Id <String>]
