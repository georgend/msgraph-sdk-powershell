...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotenotebooksection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgSiteOnenoteNotebookSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteOnenoteNotebookSection -InputObject <INotesSitesIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>]
