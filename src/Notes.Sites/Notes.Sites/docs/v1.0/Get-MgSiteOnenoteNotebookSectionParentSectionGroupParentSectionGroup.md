...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotenotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteNotebookSectionParentSectionGroupParentSectionGroup -InputObject <INotesSitesIdentity>
