...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentNotebookSectionGroupSection -InputObject <INotesSitesIdentity>
