...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionpageparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionPageParentNotebook -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
