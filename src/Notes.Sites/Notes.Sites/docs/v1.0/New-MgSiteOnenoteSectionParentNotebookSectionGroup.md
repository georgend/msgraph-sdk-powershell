...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotesectionparentnotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionParentNotebookSectionGroup -OnenoteSectionId <String> -SiteId <String>
...
### Create3
```
New-MgSiteOnenoteSectionParentNotebookSectionGroup -OnenoteSectionId <String> -SectionGroupId <String>
...
### CreateViaIdentity2
```
New-MgSiteOnenoteSectionParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
