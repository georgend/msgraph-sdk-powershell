...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgSiteOnenoteNotebookSectionPage -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
