...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentnotebooksectionpage
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentNotebookSectionPage -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgSiteOnenotePageParentNotebookSectionPage -InputObject <INotesSitesIdentity> [-ContentInputFile <String>]
