...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionParentNotebook -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
