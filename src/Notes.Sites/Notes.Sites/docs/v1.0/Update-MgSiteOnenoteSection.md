...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSection -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphOnenoteSection1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgSiteOnenoteSection -InputObject <INotesSitesIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>]
