...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepage
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePage -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteOnenotePage -InputObject <INotesSitesIdentity> [-ContentInputFile <String>]
 [-ContentUrl <String>] [-CreatedByAppId <String>] [-CreatedDateTime <DateTime>] [-Id <String>]
 [-LastModifiedDateTime <DateTime>] [-Level <Int32>] [-LinksOneNoteClientUrlHref <String>]
 [-LinksOneNoteWebUrlHref <String>] [-Order <Int32>] [-ParentNotebookCreatedBy <IMicrosoftGraphIdentitySet>]
 [-ParentNotebookCreatedDateTime <DateTime>] [-ParentNotebookDisplayName <String>]
