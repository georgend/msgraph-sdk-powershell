...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionpageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionPageParentNotebookSectionGroupSection -InputObject <INotesSitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
