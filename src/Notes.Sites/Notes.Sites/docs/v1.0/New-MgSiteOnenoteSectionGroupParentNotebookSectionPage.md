...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotesectiongroupparentnotebooksectionpage
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenoteSectionGroupParentNotebookSectionPage -InputObject <INotesSitesIdentity>
