...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectionpageparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionPageParentNotebookSectionGroupParentNotebook -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
