...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebooksectionparentsectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup
 -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm]
...
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroupParentSectionGroup
 -InputObject <INotesSitesIdentity> [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
