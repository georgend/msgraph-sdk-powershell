...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotepageparentsectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenotePageParentSectionGroupSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
