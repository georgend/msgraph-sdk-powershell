...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebooksectionparentsectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgSiteOnenotePageParentNotebookSectionParentSectionGroupParentNotebook
 -InputObject <INotesSitesIdentity> -BodyParameter <IMicrosoftGraphNotebook1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
