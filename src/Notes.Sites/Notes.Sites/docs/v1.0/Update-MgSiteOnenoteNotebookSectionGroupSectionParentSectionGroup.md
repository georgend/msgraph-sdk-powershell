...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotenotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionGroupSectionParentSectionGroup -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
