...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectionparentnotebooksectiongroup
schema: 2.0.0
---
...
### GetViaIdentity2
```
Get-MgSiteOnenoteSectionParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
