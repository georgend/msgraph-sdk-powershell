...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectiongroupparentnotebooksectiongroup
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionGroup -InputObject <INotesSitesIdentity>
