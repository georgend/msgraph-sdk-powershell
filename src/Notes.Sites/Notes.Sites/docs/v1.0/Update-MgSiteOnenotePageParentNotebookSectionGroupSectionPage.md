...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebooksectiongroupsectionpage
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentNotebookSectionGroupSectionPage -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
