...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentnotebooksectionparentnotebook
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenotePageParentNotebookSectionParentNotebook -InputObject <INotesSitesIdentity>
