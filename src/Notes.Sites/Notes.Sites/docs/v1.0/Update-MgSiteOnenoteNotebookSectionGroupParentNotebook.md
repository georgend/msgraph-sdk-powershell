...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotenotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteNotebookSectionGroupParentNotebook -InputObject <INotesSitesIdentity>
