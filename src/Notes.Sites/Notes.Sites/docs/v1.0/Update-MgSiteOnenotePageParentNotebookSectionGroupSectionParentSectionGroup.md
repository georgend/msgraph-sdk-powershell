...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotepageparentnotebooksectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgSiteOnenotePageParentNotebookSectionGroupSectionParentSectionGroup -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
