...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentsectionpage
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenotePageParentSectionPage -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>]
