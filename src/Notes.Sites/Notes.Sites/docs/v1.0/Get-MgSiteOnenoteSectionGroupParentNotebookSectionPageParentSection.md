...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotesectiongroupparentnotebooksectionpageparentsection
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentSection -InputObject <INotesSitesIdentity>
