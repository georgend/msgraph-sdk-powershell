...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/new-mgsiteonenotenotebooksectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgSiteOnenoteNotebookSectionGroupSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
