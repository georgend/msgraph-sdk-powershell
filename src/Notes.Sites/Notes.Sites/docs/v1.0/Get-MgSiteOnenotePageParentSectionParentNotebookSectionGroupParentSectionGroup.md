...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/get-mgsiteonenotepageparentsectionparentnotebooksectiongroupparentsectiongroup
schema: 2.0.0
---
...
```
Get-MgSiteOnenotePageParentSectionParentNotebookSectionGroupParentSectionGroup
 -InputObject <INotesSitesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
