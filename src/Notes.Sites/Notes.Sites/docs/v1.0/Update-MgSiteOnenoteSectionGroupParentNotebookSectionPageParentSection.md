...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.sites/update-mgsiteonenotesectiongroupparentnotebooksectionpageparentsection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgSiteOnenoteSectionGroupParentNotebookSectionPageParentSection -InputObject <INotesSitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
