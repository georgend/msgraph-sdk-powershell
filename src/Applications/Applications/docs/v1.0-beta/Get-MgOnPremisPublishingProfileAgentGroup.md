...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofileagentgroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfileAgentGroup -InputObject <IApplicationsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
