...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/update-mgonpremispublishingprofilepublishedresourceagentgroupagent
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgOnPremisPublishingProfilePublishedResourceAgentGroupAgent -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphOnPremisesAgent> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
