...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofileconnectorgroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfileConnectorGroup -InputObject <IApplicationsIdentity>
