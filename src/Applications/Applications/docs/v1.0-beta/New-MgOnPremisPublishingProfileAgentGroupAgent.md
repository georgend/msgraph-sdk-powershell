...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/new-mgonpremispublishingprofileagentgroupagent
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgOnPremisPublishingProfileAgentGroupAgent -InputObject <IApplicationsIdentity>
