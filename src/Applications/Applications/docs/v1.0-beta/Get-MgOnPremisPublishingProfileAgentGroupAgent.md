...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofileagentgroupagent
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfileAgentGroupAgent -InputObject <IApplicationsIdentity>
