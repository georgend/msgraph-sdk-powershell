...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofileagentgrouppublishedresource
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfileAgentGroupPublishedResource -InputObject <IApplicationsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
