...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/update-mgonpremispublishingprofilepublishedresource
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgOnPremisPublishingProfilePublishedResource -InputObject <IApplicationsIdentity>
