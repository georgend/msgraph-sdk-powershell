...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/update-mgonpremispublishingprofilepublishedresourceagentgroup
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgOnPremisPublishingProfilePublishedResourceAgentGroup -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphOnPremisesAgentGroup> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
