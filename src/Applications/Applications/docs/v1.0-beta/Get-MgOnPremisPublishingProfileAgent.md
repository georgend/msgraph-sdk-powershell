...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofileagent
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfileAgent -InputObject <IApplicationsIdentity> [-ExpandProperty <String[]>]
