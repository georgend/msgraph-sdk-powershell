...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofilepublishedresource
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfilePublishedResource -InputObject <IApplicationsIdentity>
