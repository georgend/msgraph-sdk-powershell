...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofilepublishedresourceagentgroupagent
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfilePublishedResourceAgentGroupAgent -InputObject <IApplicationsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
