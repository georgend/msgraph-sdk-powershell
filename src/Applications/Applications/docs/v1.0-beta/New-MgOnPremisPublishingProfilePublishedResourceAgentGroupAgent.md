...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/new-mgonpremispublishingprofilepublishedresourceagentgroupagent
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgOnPremisPublishingProfilePublishedResourceAgentGroupAgent -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphOnPremisesAgent> [-Confirm] [-WhatIf] [<CommonParameters>]
```
