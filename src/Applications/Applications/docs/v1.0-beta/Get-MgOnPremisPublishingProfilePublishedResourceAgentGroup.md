...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/get-mgonpremispublishingprofilepublishedresourceagentgroup
schema: 2.0.0
---
...
Get-MgOnPremisPublishingProfilePublishedResourceAgentGroup -OnPremisesPublishingProfileId <String>
 -PublishedResourceId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgOnPremisPublishingProfilePublishedResourceAgentGroup -InputObject <IApplicationsIdentity>
