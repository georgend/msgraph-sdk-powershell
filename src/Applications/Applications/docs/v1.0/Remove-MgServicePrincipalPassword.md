...
```
Remove-MgServicePrincipalPassword -ServicePrincipalId <String> [-KeyId <String>] [-PassThru] [-Confirm]
...
```
Remove-MgServicePrincipalPassword -InputObject <IApplicationsIdentity> [-KeyId <String>] [-PassThru]
