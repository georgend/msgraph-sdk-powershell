...
# Remove paths that are too long.
  - remove-path-by-operation: ^deviceAppManagement.wdacSupplementalPolicies.deviceStatuses.policy_assign$|^deviceAppManagement.mobileApps.userStatuses.deviceStatuses.app_getRelatedAppStates$
  # - remove-path-by-operation: ^deviceManagement.deviceHealthScripts.deviceRunStates.managedDevice_deleteUserFromSharedAppleDevice$ - used by device management.
  - where:
      verb: Update
