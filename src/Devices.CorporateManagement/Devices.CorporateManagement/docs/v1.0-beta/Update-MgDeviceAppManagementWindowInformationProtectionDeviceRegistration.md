...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementwindowinformationprotectiondeviceregistration
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementWindowInformationProtectionDeviceRegistration
 -InputObject <IDevicesCorporateManagementIdentity> [-DeviceMacAddress <String>] [-DeviceName <String>]
