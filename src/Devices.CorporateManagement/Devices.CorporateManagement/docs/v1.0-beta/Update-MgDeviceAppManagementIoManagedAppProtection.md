...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementiomanagedappprotection
schema: 2.0.0
---
...
Update-MgDeviceAppManagementIoManagedAppProtection -IosManagedAppProtectionId <String>
 ...
 [-DeviceComplianceRequired] [-DialerRestrictionLevel <String>] [-DisableAppPinIfDevicePinIsSet]
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementIoManagedAppProtection -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphIosManagedAppProtection1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
