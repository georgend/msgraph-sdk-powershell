...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmanagedappregistrationintendedpolicy
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementManagedAppRegistrationIntendedPolicy
 -InputObject <IDevicesCorporateManagementIdentity> -BodyParameter <IMicrosoftGraphManagedAppPolicy1>
...
```
Update-MgDeviceAppManagementManagedAppRegistrationIntendedPolicy
 -InputObject <IDevicesCorporateManagementIdentity> [-CreatedDateTime <DateTime>] [-Description <String>]
 [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-RoleScopeTagIds <String[]>]
 [-Version <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
