...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementiolobappprovisioningconfigurationgroupassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementIoLobAppProvisioningConfigurationGroupAssignment
 -InputObject <IDevicesCorporateManagementIdentity> [-Id <String>] [-TargetGroupId <String>] [-PassThru]
