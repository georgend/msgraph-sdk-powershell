...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementpolicysetitem
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementPolicySetItem -PolicySetId <String> -PolicySetItemId <String>
 ...
 [-PayloadId <String>] [-Status <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementPolicySetItem -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphPolicySetItem> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
