...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementwindowinformationprotectionwipeaction
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementWindowInformationProtectionWipeAction [-Count] [-ExpandProperty <String[]>]
