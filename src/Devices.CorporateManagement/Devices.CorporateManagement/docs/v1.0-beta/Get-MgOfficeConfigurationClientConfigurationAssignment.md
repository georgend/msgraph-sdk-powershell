...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgofficeconfigurationclientconfigurationassignment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgOfficeConfigurationClientConfigurationAssignment -InputObject <IDevicesCorporateManagementIdentity>
