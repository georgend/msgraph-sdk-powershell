...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementiolobappprovisioningconfigurationgroupassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementIoLobAppProvisioningConfigurationGroupAssignment
 -InputObject <IDevicesCorporateManagementIdentity> [-Id <String>] [-TargetGroupId <String>] [-Confirm]
