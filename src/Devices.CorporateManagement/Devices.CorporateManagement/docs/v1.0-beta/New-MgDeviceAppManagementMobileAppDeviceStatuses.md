...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappdevicestatuses
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgDeviceAppManagementMobileAppDeviceStatuses -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppInstallStatus> [-Confirm] [-WhatIf] [<CommonParameters>]
```
