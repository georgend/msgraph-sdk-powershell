...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementsideloadingkey
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementSideLoadingKey -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphSideLoadingKey> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
