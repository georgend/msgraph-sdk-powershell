...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagemententerprisecodesigningcertificate
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementEnterpriseCodeSigningCertificate
 -InputObject <IDevicesCorporateManagementIdentity> [-ContentInputFile <String>]
