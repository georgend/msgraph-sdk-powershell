...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileapprelatedappstate
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceAppManagementMobileAppRelatedAppState -InputObject <IDevicesCorporateManagementIdentity>
 [<CommonParameters>]
```
