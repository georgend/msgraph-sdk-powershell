...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappuserstatusesdevicestatuses
schema: 2.0.0
---
...
Get-MgDeviceAppManagementMobileAppUserStatusesDeviceStatuses -MobileAppId <String>
 -UserAppInstallStatusId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
