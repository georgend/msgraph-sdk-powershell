...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgrolemanagementdirectoryroledefinition
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgRoleManagementDirectoryRoleDefinition -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphUnifiedRoleDefinition> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
