...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementsideloadingkey
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceAppManagementSideLoadingKey -InputObject <IDevicesCorporateManagementIdentity>
