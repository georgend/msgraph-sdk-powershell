...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappuserstatuses
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementMobileAppUserStatuses -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphUserAppInstallStatus> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
