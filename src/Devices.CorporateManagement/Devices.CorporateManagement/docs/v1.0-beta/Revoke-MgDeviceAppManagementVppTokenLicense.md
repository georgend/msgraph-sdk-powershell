...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/revoke-mgdeviceappmanagementvpptokenlicense
schema: 2.0.0
---
...
### RevokeViaIdentity
```
Revoke-MgDeviceAppManagementVppTokenLicense -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IPaths1C1UpkDeviceappmanagementVpptokensVpptokenIdMicrosoftGraphRevokelicensesPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
