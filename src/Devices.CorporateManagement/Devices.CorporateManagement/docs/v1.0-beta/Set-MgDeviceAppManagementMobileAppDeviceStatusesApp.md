...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgdeviceappmanagementmobileappdevicestatusesapp
schema: 2.0.0
---
...
### AssignViaIdentity
```
Set-MgDeviceAppManagementMobileAppDeviceStatusesApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IPaths2Hf785DeviceappmanagementMobileappsMobileappIdDevicestatusesMobileappinstallstatusIdAppMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
