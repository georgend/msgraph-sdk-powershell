...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgdeviceappmanagementmobileappuserstatusesapp
schema: 2.0.0
---
...
### AssignViaIdentity
```
Set-MgDeviceAppManagementMobileAppUserStatusesApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IPaths11FmydoDeviceappmanagementMobileappsMobileappIdUserstatusesUserappinstallstatusIdAppMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
