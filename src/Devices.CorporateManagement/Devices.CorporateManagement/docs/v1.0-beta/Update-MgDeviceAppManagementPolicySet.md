...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementpolicyset
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementPolicySet -InputObject <IDevicesCorporateManagementIdentity>
