...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappuserstatusesdevicestatuses
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppUserStatusesDeviceStatuses
 -InputObject <IDevicesCorporateManagementIdentity> [-App <IMicrosoftGraphMobileApp>] [-DeviceId <String>]
