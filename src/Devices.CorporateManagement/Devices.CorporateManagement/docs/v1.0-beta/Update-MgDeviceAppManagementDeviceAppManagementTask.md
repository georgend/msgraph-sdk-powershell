...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementdeviceappmanagementtask
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementDeviceAppManagementTask -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceAppManagementTask> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
