...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgrolemanagementdevicemanagementroleassignmentappscope
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgRoleManagementDeviceManagementRoleAssignmentAppScope -InputObject <IDevicesCorporateManagementIdentity>
