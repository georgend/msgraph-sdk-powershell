...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementtargetedmanagedappconfigurationassignment
schema: 2.0.0
---
...
Update-MgDeviceAppManagementTargetedManagedAppConfigurationAssignment
 ...
 [-Source <String>] [-SourceId <String>] [-TargetDeviceAndAppManagementAssignmentFilterId <String>]
