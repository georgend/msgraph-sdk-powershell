...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementwdacsupplementalpolicydeploysummary
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementWdacSupplementalPolicyDeploySummary
 -WindowsDefenderApplicationControlSupplementalPolicyId <String> [-DeployedDeviceCount <Int32>]
 [-FailedDeviceCount <Int32>] [-Id <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgDeviceAppManagementWdacSupplementalPolicyDeploySummary
 -InputObject <IDevicesCorporateManagementIdentity> [-DeployedDeviceCount <Int32>]
 [-FailedDeviceCount <Int32>] [-Id <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
