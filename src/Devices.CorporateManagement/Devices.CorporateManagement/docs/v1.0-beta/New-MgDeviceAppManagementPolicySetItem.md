...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementpolicysetitem
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgDeviceAppManagementPolicySetItem -InputObject <IDevicesCorporateManagementIdentity>
