...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgrolemanagementdirectoryroleassignmentappscope
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgRoleManagementDirectoryRoleAssignmentAppScope -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphAppScope> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
