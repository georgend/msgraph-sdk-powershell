...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementiomanagedappprotectionapp
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgDeviceAppManagementIoManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-Confirm] [-WhatIf] [<CommonParameters>]
```
