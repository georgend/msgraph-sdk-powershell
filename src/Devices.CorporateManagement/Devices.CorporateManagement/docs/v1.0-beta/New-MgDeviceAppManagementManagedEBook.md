...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmanagedebook
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementManagedEBook [-Assignments <IMicrosoftGraphManagedEBookAssignment1[]>]
