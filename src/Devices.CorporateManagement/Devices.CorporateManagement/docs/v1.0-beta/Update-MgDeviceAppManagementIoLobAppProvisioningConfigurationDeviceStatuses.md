...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementiolobappprovisioningconfigurationdevicestatuses
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementIoLobAppProvisioningConfigurationDeviceStatuses
 -InputObject <IDevicesCorporateManagementIdentity> [-ComplianceGracePeriodExpirationDateTime <DateTime>]
