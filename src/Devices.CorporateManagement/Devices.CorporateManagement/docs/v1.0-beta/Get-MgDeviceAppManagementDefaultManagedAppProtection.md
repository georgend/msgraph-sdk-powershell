...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementdefaultmanagedappprotection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementDefaultManagedAppProtection [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
