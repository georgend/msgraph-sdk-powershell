...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementwindowinformationprotectiondeviceregistration
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementWindowInformationProtectionDeviceRegistration [-DeviceMacAddress <String>]
 [-DeviceName <String>] [-DeviceRegistrationId <String>] [-DeviceType <String>] [-Id <String>]
 [-LastCheckInDateTime <DateTime>] [-UserId <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
