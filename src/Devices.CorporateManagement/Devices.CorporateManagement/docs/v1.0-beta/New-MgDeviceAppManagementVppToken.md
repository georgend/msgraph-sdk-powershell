...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementvpptoken
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementVppToken [-AppleId <String>] [-AutomaticallyUpdateApps]
...
### Create
```
New-MgDeviceAppManagementVppToken -BodyParameter <IMicrosoftGraphVppToken2> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
