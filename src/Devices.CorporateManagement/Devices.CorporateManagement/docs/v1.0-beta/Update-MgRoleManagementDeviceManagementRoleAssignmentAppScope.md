...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgrolemanagementdevicemanagementroleassignmentappscope
schema: 2.0.0
---
...
```
Update-MgRoleManagementDeviceManagementRoleAssignmentAppScope
 -InputObject <IDevicesCorporateManagementIdentity> -BodyParameter <IMicrosoftGraphAppScope> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgRoleManagementDeviceManagementRoleAssignmentAppScope
 -InputObject <IDevicesCorporateManagementIdentity> [-DisplayName <String>] [-Id <String>] [-Type <String>]
