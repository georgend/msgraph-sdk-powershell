...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgofficeconfigurationclientconfiguration
schema: 2.0.0
---
...
### AssignViaIdentity
```
Set-MgOfficeConfigurationClientConfiguration -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IPathsMtl0Z8OfficeconfigurationClientconfigurationsOfficeclientconfigurationIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
