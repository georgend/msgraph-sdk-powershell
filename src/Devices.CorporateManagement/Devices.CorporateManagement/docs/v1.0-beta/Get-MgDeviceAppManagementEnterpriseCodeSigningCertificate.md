...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagemententerprisecodesigningcertificate
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceAppManagementEnterpriseCodeSigningCertificate -InputObject <IDevicesCorporateManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
