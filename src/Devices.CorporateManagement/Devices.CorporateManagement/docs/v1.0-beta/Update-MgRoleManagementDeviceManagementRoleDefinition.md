...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgrolemanagementdevicemanagementroledefinition
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgRoleManagementDeviceManagementRoleDefinition -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphUnifiedRoleDefinition> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
