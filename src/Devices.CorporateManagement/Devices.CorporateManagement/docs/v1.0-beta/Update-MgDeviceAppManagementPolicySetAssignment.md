...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementpolicysetassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementPolicySetAssignment -PolicySetAssignmentId <String> -PolicySetId <String>
 [-Id <String>] [-LastModifiedDateTime <DateTime>] [-TargetDeviceAndAppManagementAssignmentFilterId <String>]
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementPolicySetAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphPolicySetAssignment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
