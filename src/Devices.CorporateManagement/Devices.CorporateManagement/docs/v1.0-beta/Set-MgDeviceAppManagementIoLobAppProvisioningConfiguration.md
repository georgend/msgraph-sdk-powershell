...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgdeviceappmanagementiolobappprovisioningconfiguration
schema: 2.0.0
---
...
### AssignViaIdentity
```
Set-MgDeviceAppManagementIoLobAppProvisioningConfiguration -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IPathsNqkqhnDeviceappmanagementIoslobappprovisioningconfigurationsIoslobappprovisioningconfigurationIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
