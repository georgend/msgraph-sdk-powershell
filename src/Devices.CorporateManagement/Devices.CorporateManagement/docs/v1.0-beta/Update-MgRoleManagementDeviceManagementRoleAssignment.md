...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgrolemanagementdevicemanagementroleassignment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgRoleManagementDeviceManagementRoleAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphUnifiedRoleAssignmentMultiple> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
