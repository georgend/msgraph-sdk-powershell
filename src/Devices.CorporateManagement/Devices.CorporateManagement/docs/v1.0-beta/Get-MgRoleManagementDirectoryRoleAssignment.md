...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgrolemanagementdirectoryroleassignment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgRoleManagementDirectoryRoleAssignment -InputObject <IDevicesCorporateManagementIdentity>
