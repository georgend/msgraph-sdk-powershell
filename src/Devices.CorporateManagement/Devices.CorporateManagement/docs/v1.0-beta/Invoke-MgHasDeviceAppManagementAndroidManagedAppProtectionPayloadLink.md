...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/invoke-mghasdeviceappmanagementandroidmanagedappprotectionpayloadlink
schema: 2.0.0
---
...
### HasExpanded (Default)
```
Invoke-MgHasDeviceAppManagementAndroidManagedAppProtectionPayloadLink [-PayloadIds <String[]>] [-Confirm]
