...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgrolemanagementdirectoryroleassignmentappscope
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgRoleManagementDirectoryRoleAssignmentAppScope -InputObject <IDevicesCorporateManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
