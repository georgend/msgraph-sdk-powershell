...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappdevicestatuses
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementMobileAppDeviceStatuses -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppInstallStatus> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
