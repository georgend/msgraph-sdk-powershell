...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedappstatuses
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgDeviceAppManagementManagedAppStatuses -InputObject <IDevicesCorporateManagementIdentity>
