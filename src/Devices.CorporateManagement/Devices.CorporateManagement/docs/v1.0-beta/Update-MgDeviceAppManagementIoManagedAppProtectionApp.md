...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementiomanagedappprotectionapp
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgDeviceAppManagementIoManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
