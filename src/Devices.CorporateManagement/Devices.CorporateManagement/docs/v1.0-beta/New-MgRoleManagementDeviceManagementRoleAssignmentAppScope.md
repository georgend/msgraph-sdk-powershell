...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgrolemanagementdevicemanagementroleassignmentappscope
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgRoleManagementDeviceManagementRoleAssignmentAppScope -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphAppScope> [-Confirm] [-WhatIf] [<CommonParameters>]
```
