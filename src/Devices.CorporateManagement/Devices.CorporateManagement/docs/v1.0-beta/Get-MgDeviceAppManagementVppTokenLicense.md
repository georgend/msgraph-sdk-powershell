...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementvpptokenlicense
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementVppTokenLicense -BundleId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceAppManagementVppTokenLicense -InputObject <IDevicesCorporateManagementIdentity>
 [<CommonParameters>]
```
