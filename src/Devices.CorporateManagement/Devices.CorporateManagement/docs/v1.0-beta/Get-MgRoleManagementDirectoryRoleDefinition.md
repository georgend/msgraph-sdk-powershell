...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgrolemanagementdirectoryroledefinition
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgRoleManagementDirectoryRoleDefinition -InputObject <IDevicesCorporateManagementIdentity>
