...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedebook
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementManagedEBook [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
