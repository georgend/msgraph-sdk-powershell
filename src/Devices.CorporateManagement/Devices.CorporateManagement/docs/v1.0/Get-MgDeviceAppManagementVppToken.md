...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementvpptoken
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgDeviceAppManagementVppToken [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
