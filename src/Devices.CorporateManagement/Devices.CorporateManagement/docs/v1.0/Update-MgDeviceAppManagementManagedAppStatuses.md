...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmanagedappstatuses
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementManagedAppStatuses -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedAppStatus> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
