...
```
Update-MgAgreementAcceptance -AgreementAcceptanceId <String> -AgreementId <String> [-AgreementFileId <String>]
...
```
Update-MgAgreementAcceptance -InputObject <IIdentityTermsOfUseIdentity> [-AgreementId <String>]
