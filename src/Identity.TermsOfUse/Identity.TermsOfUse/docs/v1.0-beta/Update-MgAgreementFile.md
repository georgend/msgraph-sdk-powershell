...
```
Update-MgAgreementFile -AgreementId <String> [-FileDataDataInputFile <String>] [-FileName <String>]
 [-Id <String>] [-IsDefault] [-Language <String>]
...
Update-MgAgreementFile -InputObject <IIdentityTermsOfUseIdentity> [-FileDataDataInputFile <String>]
 [-FileName <String>] [-Id <String>] [-IsDefault] [-Language <String>]
 [-Localizations <IMicrosoftGraphAgreementFileLocalization[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
