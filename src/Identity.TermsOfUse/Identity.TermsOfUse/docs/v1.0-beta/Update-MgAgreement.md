...
Update-MgAgreement -AgreementId <String> [-Acceptances <IMicrosoftGraphAgreementAcceptance[]>]
 [-DisplayName <String>] [-FileFileDataDataInputFile <String>] [-FileId <String>] [-FileIsDefault]
 [-FileLanguage <String>] [-FileLocalizations <IMicrosoftGraphAgreementFileLocalization[]>]
 [-FileName <String>] [-Files <IMicrosoftGraphAgreementFileLocalization[]>] [-Id <String>]
 [-IsPerDeviceAcceptanceRequired] [-IsViewingBeforeAcceptanceRequired] [-TermExpirationFrequency <TimeSpan>]
 [-TermExpirationStartDateTime <DateTime>] [-UserReacceptRequiredFrequency <TimeSpan>] [-PassThru] [-Confirm]
...
```
Update-MgAgreement -InputObject <IIdentityTermsOfUseIdentity>
 [-Acceptances <IMicrosoftGraphAgreementAcceptance[]>] [-DisplayName <String>]
