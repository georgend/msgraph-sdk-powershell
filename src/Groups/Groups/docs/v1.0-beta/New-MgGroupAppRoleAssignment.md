...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/new-mggroupapproleassignment
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgGroupAppRoleAssignment -InputObject <IGroupsIdentity> -BodyParameter <IMicrosoftGraphAppRoleAssignment1>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgGroupAppRoleAssignment -InputObject <IGroupsIdentity> [-AppRoleId <String>]
