...
### UpdateViaIdentity1
```
Update-MgGroupExtension -InputObject <IGroupsIdentity> -BodyParameter <IMicrosoftGraphExtension> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupExtension -InputObject <IGroupsIdentity> [-Id <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
