...
```
Confirm-MgGroupSettingTemplateMemberObject -GroupSettingTemplateId <String> [-Ids <String[]>] [-Confirm]
...
```
Confirm-MgGroupSettingTemplateMemberObject -InputObject <IGroupsIdentity> [-Ids <String[]>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
