...
```
Update-MgGroupSetting -GroupId <String> -GroupSettingId <String> [-DisplayName <String>] [-Id <String>]
...
```
Update-MgGroupSetting -InputObject <IGroupsIdentity> [-DisplayName <String>] [-Id <String>]
 [-TemplateId <String>] [-Values <IMicrosoftGraphSettingValue[]>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -GroupSettingId
key: groupSetting-id of groupSetting
