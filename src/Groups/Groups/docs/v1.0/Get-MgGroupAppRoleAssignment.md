...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/get-mggroupapproleassignment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupAppRoleAssignment -InputObject <IGroupsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
