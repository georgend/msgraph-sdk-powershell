...
### GetExpanded (Default)
```
Get-MgGroupSettingTemplateMemberGroup -GroupSettingTemplateId <String> [-SecurityEnabledOnly] [-Confirm]
...
```
Get-MgGroupSettingTemplateMemberGroup -InputObject <IGroupsIdentity> [-SecurityEnabledOnly] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
