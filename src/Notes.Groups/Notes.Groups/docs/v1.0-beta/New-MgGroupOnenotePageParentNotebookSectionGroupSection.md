...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/new-mggrouponenotepageparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgGroupOnenotePageParentNotebookSectionGroupSection -InputObject <INotesGroupsIdentity>
