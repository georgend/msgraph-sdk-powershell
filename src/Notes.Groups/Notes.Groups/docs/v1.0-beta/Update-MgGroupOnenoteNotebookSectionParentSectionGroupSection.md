...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/update-mggrouponenotenotebooksectionparentsectiongroupsection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteNotebookSectionParentSectionGroupSection -InputObject <INotesGroupsIdentity>
