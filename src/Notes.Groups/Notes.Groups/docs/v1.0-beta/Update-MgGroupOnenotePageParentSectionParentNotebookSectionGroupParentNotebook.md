...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/update-mggrouponenotepageparentsectionparentnotebooksectiongroupparentnotebook
schema: 2.0.0
---
...
```
Update-MgGroupOnenotePageParentSectionParentNotebookSectionGroupParentNotebook
 -InputObject <INotesGroupsIdentity> -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
