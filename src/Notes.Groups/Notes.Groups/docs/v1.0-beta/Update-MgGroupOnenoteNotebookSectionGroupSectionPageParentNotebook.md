...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/update-mggrouponenotenotebooksectiongroupsectionpageparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteNotebookSectionGroupSectionPageParentNotebook -InputObject <INotesGroupsIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
