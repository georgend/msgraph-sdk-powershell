...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/new-mggrouponenotepageparentnotebooksectiongroup
schema: 2.0.0
---
...
### CreateViaIdentity2
```
New-MgGroupOnenotePageParentNotebookSectionGroup -InputObject <INotesGroupsIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
