...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/update-mggrouponenotepageparentnotebook
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupOnenotePageParentNotebook -InputObject <INotesGroupsIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
