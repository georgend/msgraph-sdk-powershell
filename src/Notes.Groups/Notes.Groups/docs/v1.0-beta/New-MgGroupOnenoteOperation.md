...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/new-mggrouponenoteoperation
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgGroupOnenoteOperation -InputObject <INotesGroupsIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteOperation> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgGroupOnenoteOperation -InputObject <INotesGroupsIdentity> [-Code <String>] [-CreatedDateTime <DateTime>]
