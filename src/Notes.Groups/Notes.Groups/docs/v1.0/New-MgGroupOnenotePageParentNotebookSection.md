...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/new-mggrouponenotepageparentnotebooksection
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgGroupOnenotePageParentNotebookSection -InputObject <INotesGroupsIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection1> [-Confirm] [-WhatIf] [<CommonParameters>]
```
