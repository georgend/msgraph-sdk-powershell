...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/get-mggrouponenotesectiongroupsectionparentsectiongroup
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgGroupOnenoteSectionGroupSectionParentSectionGroup -InputObject <INotesGroupsIdentity>
