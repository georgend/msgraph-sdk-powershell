...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes.groups/update-mggrouponenotesectionparentnotebooksectiongroupsection
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupOnenoteSectionParentNotebookSectionGroupSection -InputObject <INotesGroupsIdentity>
