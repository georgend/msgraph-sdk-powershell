...
### List (Default)
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> [-Count] [-ExpandProperty <String[]>]
...
### List1
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> -SalesOrderId <String> [-Count]
