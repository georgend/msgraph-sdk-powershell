...
### List1 (Default)
```
Get-MgFinancialCompanyDimensionValue -CompanyId <String> [-Count] [-ExpandProperty <String[]>]
...
### List
```
Get-MgFinancialCompanyDimensionValue -CompanyId <String> -DimensionId <String> [-Count]
