...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.accessreviews/update-mgaccessreviewinstance
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgAccessReviewInstance -InputObject <IIdentityAccessReviewsIdentity>
 -BodyParameter <IMicrosoftGraphAccessReview> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
