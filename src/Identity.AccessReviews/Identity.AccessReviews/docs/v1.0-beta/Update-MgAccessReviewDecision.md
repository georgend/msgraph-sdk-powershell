...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.accessreviews/update-mgaccessreviewdecision
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgAccessReviewDecision -InputObject <IIdentityAccessReviewsIdentity>
 -BodyParameter <IMicrosoftGraphAccessReviewDecision> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgAccessReviewDecision -InputObject <IIdentityAccessReviewsIdentity> [-AccessReviewId <String>]
