...
```
Update-MgInformationProtectionDataLossPreventionPolicy -DataLossPreventionPolicyId <String> [-Id <String>]
...
```
Update-MgInformationProtectionDataLossPreventionPolicy -InputObject <IIdentitySignInsIdentity> [-Id <String>]
 [-Name <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
key: dataLossPreventionPolicy-id of dataLossPreventionPolicy
