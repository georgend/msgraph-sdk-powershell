...
```
Update-MgUserAuthenticationOperation -InputObject <IIdentitySignInsIdentity> [-CreatedDateTime <DateTime>]
 [-Id <String>] [-LastActionDateTime <DateTime>] [-ResourceLocation <String>] [-Status <String>]
 [-StatusDetail <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
