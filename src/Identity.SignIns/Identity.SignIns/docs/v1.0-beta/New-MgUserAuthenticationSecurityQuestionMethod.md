...
```
New-MgUserAuthenticationSecurityQuestionMethod -UserId <String> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgUserAuthenticationSecurityQuestionMethod -UserId <String>
 -BodyParameter <IMicrosoftGraphSecurityQuestionAuthenticationMethod> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgUserAuthenticationSecurityQuestionMethod -InputObject <IIdentitySignInsIdentity> [-Id <String>]
