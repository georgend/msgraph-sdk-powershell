...
```
Update-MgUserAuthenticationOathMethod -InputObject <IIdentitySignInsIdentity> [-Id <String>] [-PassThru]
...
key: softwareOathAuthenticationMethod-id of softwareOathAuthenticationMethod
