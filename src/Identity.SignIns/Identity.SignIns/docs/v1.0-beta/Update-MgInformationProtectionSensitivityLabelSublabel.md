...
Update-MgInformationProtectionSensitivityLabelSublabel -SensitivityLabelId <String>
 -SensitivityLabelId1 <String> [-ApplicableTo <String>] [-ApplicationMode <String>]
 [-AssignedPolicies <IMicrosoftGraphLabelPolicy[]>] [-AutoLabelingMessage <String>]
 [-AutoLabelingSensitiveTypeIds <String[]>] [-Description <String>] [-DisplayName <String>] [-Id <String>]
...
Update-MgInformationProtectionSensitivityLabelSublabel -InputObject <IIdentitySignInsIdentity>
 ...
 [-AutoLabelingMessage <String>] [-AutoLabelingSensitiveTypeIds <String[]>] [-Description <String>]
...
### -SensitivityLabelId
key: sensitivityLabel-id of sensitivityLabel
