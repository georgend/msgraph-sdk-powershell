...
```
New-MgInformationProtectionPolicyLabel [-Color <String>] [-Description <String>] [-Id <String>] [-IsActive]
 [-Name <String>] [-Sensitivity <Int32>] [-Tooltip <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
