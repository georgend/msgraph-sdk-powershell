...
```
Update-MgUserAuthenticationFido2Method -Fido2AuthenticationMethodId <String> -UserId <String> [-Id <String>]
...
```
Update-MgUserAuthenticationFido2Method -InputObject <IIdentitySignInsIdentity> [-Id <String>] [-PassThru]
...
key: fido2AuthenticationMethod-id of fido2AuthenticationMethod
