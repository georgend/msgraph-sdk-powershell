...
```
Update-MgUserAuthenticationEmailMethod -EmailAuthenticationMethodId <String> -UserId <String> [-Id <String>]
...
```
Update-MgUserAuthenticationEmailMethod -InputObject <IIdentitySignInsIdentity> [-Id <String>] [-PassThru]
...
key: emailAuthenticationMethod-id of emailAuthenticationMethod
