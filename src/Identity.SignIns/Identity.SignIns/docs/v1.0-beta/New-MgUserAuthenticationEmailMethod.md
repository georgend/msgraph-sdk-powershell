...
```
New-MgUserAuthenticationEmailMethod -UserId <String> [-Id <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgUserAuthenticationEmailMethod -InputObject <IIdentitySignInsIdentity> [-Id <String>] [-Confirm]
