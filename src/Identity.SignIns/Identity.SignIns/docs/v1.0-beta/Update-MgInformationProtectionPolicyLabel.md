...
```
Update-MgInformationProtectionPolicyLabel -InformationProtectionLabelId <String> [-Color <String>]
...
```
Update-MgInformationProtectionPolicyLabel -InputObject <IIdentitySignInsIdentity> [-Color <String>]
 [-Description <String>] [-Id <String>] [-IsActive] [-Name <String>] [-Sensitivity <Int32>]
 [-Tooltip <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
key: informationProtectionLabel-id of informationProtectionLabel
