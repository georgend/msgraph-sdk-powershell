...
```
New-MgUserAuthenticationMicrosoftAuthenticatorMethod -UserId <String> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgUserAuthenticationMicrosoftAuthenticatorMethod -InputObject <IIdentitySignInsIdentity> [-Id <String>]
