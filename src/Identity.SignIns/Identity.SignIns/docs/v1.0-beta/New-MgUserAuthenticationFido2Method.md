...
```
New-MgUserAuthenticationFido2Method -UserId <String> [-Id <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgUserAuthenticationFido2Method -InputObject <IIdentitySignInsIdentity> [-Id <String>] [-Confirm]
