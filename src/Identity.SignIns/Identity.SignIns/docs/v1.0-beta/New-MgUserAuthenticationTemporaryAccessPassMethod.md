...
```
New-MgUserAuthenticationTemporaryAccessPassMethod -UserId <String> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgUserAuthenticationTemporaryAccessPassMethod -InputObject <IIdentitySignInsIdentity> [-Id <String>]
