...
### UpdateViaIdentity
```
Update-MgTrustFrameworkPolicy -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphTrustFrameworkPolicy> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgTrustFrameworkPolicy -InputObject <IIdentitySignInsIdentity> [-Id <String>] [-PassThru] [-Confirm]
