...
```
Update-MgInformationProtection [-DataLossPreventionPolicies <IMicrosoftGraphDataLossPreventionPolicy[]>]
 [-Id <String>] [-PolicyId <String>] [-PolicyLabels <IMicrosoftGraphInformationProtectionLabel[]>]
