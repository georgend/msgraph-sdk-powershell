...
```
Update-MgPrintOperation -PrintOperationId <String> [-CreatedDateTime <DateTime>] [-Id <String>]
 [-StatusDescription <String>] [-StatusState <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgPrintOperation -InputObject <IDevicesCloudPrintIdentity> [-CreatedDateTime <DateTime>] [-Id <String>]
 [-StatusDescription <String>] [-StatusState <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -PrintOperationId
key: printOperation-id of printOperation
